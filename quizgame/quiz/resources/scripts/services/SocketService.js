...
function SocketService() {
				...
				.connect(
						...
						function(frame) {
							...
							if (!isBroadcastAll) {
								...
								url = url
										.replace(
												"ws://localhost:8084/quizgame/secured/room/",
												"");
	...
	that.messageOut = function(msg, opts) {
		...
		p.appendChild(document.createTextNode(msg.from + ': ' + msg.text + ' ('
				+ msg.time + ')'));
		r.appendChild(p);
	};
...
angularApp.service('SocketService', SocketService);